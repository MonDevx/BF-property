...
import NavigationDrawer from "../../customs/ืnavigationdrawer/navigationdrawer.js";
...
function Header(props) {
  ...
  const [selectedIndex, setSelectedIndex] = React.useState(
    props.lang === "en" ? 0 : i18n.language === "th" ? 1 : 2
  );
  const [selectedIndexCurrency, setSelectedIndexCurrency] = React.useState(
    props.currency === "en" ? 0 : props.currency === "th" ? 1 : 2
  );
  ...
  const optionsCurrency = [t("dollar.label"), t("baht.label"), t("yuan.label")];
  const langoptions = ["en", "th", "cn"];
          ...
          <div>
            ...
            <Hidden smDown>
              ...
              <Tooltip title={t("langbutton")}>
                ...
                >
                  <ReactCountryFlag
                    countryCode={props.lang === "en" ? "gb" : props.lang}
                    svg
                    style={{
                      width: "1.7em",
                      height: "1.7em",
              ...
              >
                {options.map((option, index) => (
                  ...
                  >
                    <ReactCountryFlag
                      countryCode={langoptions[index] === "en" ? "gb" : langoptions[index]}
                      svg
                      style={{
                        width: "1.5em",
                        height: "1.5em",
