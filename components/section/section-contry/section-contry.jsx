...
export default function Sectioncontry() {
  ...
  const { t } = useTranslation("section-contry");
  const images = [
    {
      urljpg: "/img/contry/bangkok.jpg",
      urlwebp: "/img/webp/contry/bangkok.webp",
    ...
    {
      urljpg: "/img/contry/chiangmai.jpg",
      urlwebp: "/img/webp/contry/chiangmai.webp",
    ...
    {
      urljpg: "/img/contry/rayong.jpg",
      urlwebp: "/img/webp/contry/rayong.webp",
    ...
    {
      urljpg: "/img/contry/chonburi.jpg",
      urlwebp: "/img/webp/contry/chonburi.webp",
