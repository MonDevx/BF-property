...
export default function Sectionhowto() {
  ...
  const { t } = useTranslation("section-howto");
  return (
              ...
              <div className={classes.item}>
                ...
                <LazyLoadImage
                  src={
                    ...
                    "/img/webp/section-howto/undraw_buffer_wq43.webp"
                  }
                  alt="img1"
                  effect="blur"
                  width="256px"
              ...
              <div className={classes.item}>
                ...
                <LazyLoadImage
                  src={
                    ...
                    "/img/webp/section-howto/undraw_all_the_data_h4ki.webp"
                  }
                  alt="img2"
                  effect="blur"
                  width="256px"
              ...
              <div className={classes.item}>
                ...
                <LazyLoadImage
                  src={
                    ...
                    "/img/webp/section-howto/undraw_Search_1px8.webp"
                  }
                  alt="img3"
                  effect="blur"
                  width="256px"
